...
class Cube:
    def __init__(self, app):
        ...
        self.texture = self.get_texture('textures/USCimage.png')
        self.on_init()
    ...
    def update(self):
        m_model = glm.rotate(self.m_model, self.app.time * 0.5, glm.vec3(0.0, 1.0, 0.0))
    ...
    def on_init(self):
        ...
        #  specify the name of the texture 
    ...
    def get_vao(self):
        ...
        # vao = self.ctx.vertex_array(self.shader_program, [(self.vbo, '3f 2f', 'in_position', 'in_texcoord_0')])
    ...
    #  this is sending the data to the GPU memory for rendering
    def get_vbo(self):
...
class Cube1:
    ...
    def get_model_matrix(self):
        ...
        m_model = glm.rotate(m_model, self.rot.x, glm.vec3(1.0, 0.0, 0.0))
        m_model = glm.rotate(m_model, self.rot.y, glm.vec3(0.0, 1.0, 0.0))
        m_model = glm.rotate(m_model, self.rot.z, glm.vec3(0.0, 0.0, 1.0))
        return m_model
